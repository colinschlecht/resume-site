      ...
      <div className="content" id="project">
        <div id="content-header">
          ...
          <div className="content projects">
            ...
            <div className="project">
              <p className="description">
                A brewery locator web service, where users can comment and
                review local breweries by location
              </p>
              <ul>
                <li>
                  Enabled user authentication and authorization through
                ...
                <li>
                  ...
                  efficiently route the user to curated content based on
                  location.
                </li>
                <li>
          ...
          <div className="content experience">
            ...
            <div className="job title">
              <h4>
                Customer Support{" "}
                <span className="location">Sumner, Wa | 10/2016 - 11/2020</span>
              </h4>
            </div>
              ...
              <div className="job title">
                <h4>
                  ...
                  <span className="location">
                    Kent, Wa | 02/2017 - 06/2017, 05/2018 - 10/2018
                  </span>
                </h4>
              </div>
              <div className="job description">
          ...
          <div className="education">
            ...
            <div className="school">
              <h4>
                Flatiron School
                <span className="location">Seattle, Wa | 1/2021 - 04/2021</span>
              </h4>
            </div>
            ...
            <div className="school">
              <h4>
                ...
                <span className="location">
                  Ellensburg, Wa | Graduated: 06/2010
                </span>
              </h4>
